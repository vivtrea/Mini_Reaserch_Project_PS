...
# Note: In this dataset, pure 'Susceptible' cases are very rare.
group_r <- dataset_readed$age[dataset_readed$Resistance_Status == 'Resistant' & !is.na(dataset_readed$age)]
group_s <- dataset_readed$age[dataset_readed$Resistance_Status == 'Susceptible' & !is.na(dataset_readed$age)]
...
diabetic_r <- dataset_readed$ID[dataset_readed$Resistance_Status == 'Resistant' & !is.na(dataset_readed$Diabetes) & dataset_readed$Diabetes == "True" ]
diabetic_s <- dataset_readed$ID[dataset_readed$Resistance_Status == 'Susceptible' & !is.na(dataset_readed$Diabetes) & dataset_readed$Diabetes == "True" ]

nondiabetic_r <- dataset_readed$ID[dataset_readed$Resistance_Status == 'Resistant' & !is.na(dataset_readed$Diabetes) & dataset_readed$Diabetes == "No" ]
nondiabetic_s <-  dataset_readed$ID[dataset_readed$Resistance_Status == 'Susceptible' & !is.na(dataset_readed$Diabetes) & dataset_readed$Diabetes == "No" ]
```

```{r}

contingency_table <- table(dataset_readed$Diabetes[!is.na(dataset_readed$Diabetes)], 
                           dataset_readed$Resistance_Status[!is.na(dataset_readed$Diabetes)])
